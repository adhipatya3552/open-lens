  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <div className="rounded-xl bg-gradient-to-br from-green-500 to-green-600 p-6 text-white sm:col-span-2 lg:col-span-1">
          <div className="flex items-center">
            <div className="rounded-lg bg-white/20 p-3">
              <svg
                className="h-6 w-6"
            ...
            <div className="ml-4">
              <h3 className="text-lg font-medium">Earnings Today</h3>
              <p className="mt-1 text-2xl font-semibold">
                $
                {data.dailyEarnings[data.dailyEarnings.length - 1]?.amount.toFixed(
                  2
                ) || "0.00"}
              </p>
            </div>
